 ...
 * travels into it.  Generally, when updating client, we must grab their own region and the closest adjacent
 ...
 * all the game does is traverse the client generated path.  This may change in the future to the game
 ...
 * which walks through walls, currently the game code will honor that path and walk right through the wall,
 * since I haven't loaded the map data into memory on the game yet.  Once I load the map into the game,
